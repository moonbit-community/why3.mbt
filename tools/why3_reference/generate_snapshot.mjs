...
function exportSnapshot(why3Root, theoryRoots, runtime) {
...
function renderShard(functionName, bytes) {
  ...
  return [
    '// SPDX-License-Identifier: LGPL-2.1-only WITH OCaml-LGPL-linking-exception',
    '// @generated by tools/why3_reference/generate_snapshot.mjs; do not edit.',
    '',
    '///|',
...
function buildOutputs(why3Root, archiveVerified, runtime) {
  const inventory = buildInventory(why3Root, { archiveVerified, runtime });
  ...
  const rawSnapshot = exportSnapshot(
    why3Root,
    inventory.driver.theoryRoots,
    runtime,
  );
  ...
  const sourceFiles = [
    ['tools/why3_reference/generate_snapshot.mjs', GENERATOR_SOURCE],
    ['tools/why3_reference/export_snapshot.ml', EXPORTER_SOURCE],
    ['tools/why3_reference/export_semantic_inventory.ml', INVENTORY_EXPORTER_SOURCE],
    ['tools/why3_reference/export_driver_inventory.mjs', DRIVER_EXPORTER_SOURCE],
...
export function main(argv = process.argv.slice(2)) {
  ...
  try {
    ...
    const result = withWhy3Source(options, (why3Root, archiveVerified) =>
      buildOutputs(why3Root, archiveVerified, runtime));
