...
(*                                                                  *)
(*  MoonBit canonical reference adapter, modified 2026-07-22.          *)
(*                                                                  *)
(********************************************************************)
...
let smt_identifier_event ordinal identifier original_token =
  let marker_token = Printf.sprintf "|@why3-reference-id-%d|" ordinal in
...
let semantic_profile_sha256 =
  "bc2e01a30b60d325e17cde6875271c90f46e2264bb4bb856a66bd16cee02ccf9"
